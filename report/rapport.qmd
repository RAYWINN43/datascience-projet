...
| Avg VTAT | Temps moyen pour que le chauffeur atteigne le point de prise en charge (en minutes) |
| Avg CTAT | Durée moyenne du trajet entre le départ et la destination (en minutes) |
...
distance du trajet (*Ride Distance*), le type de véhicule (*Vehicle Type*) ou encore le
